...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    {
    case WM_CREATE:
        CreateWindow(L"button", L"PUSH", WS_CHILD | WS_VISIBLE,
            10, 10, 200, 50, hWnd, (HMENU)777, hInst, NULL);
        srand(time(NULL));
        break;
    case WM_LBUTTONDOWN:
    //case WM_MOUSEMOVE:
    {
        ...
        /// 1. 펜 객체 생성
        /// PS_SOLID : 선의 종류, 실선/점선 ...
        /// 5 : 선의 굵기
        /// RGB(r, g, b) : 값의 범위 0 ~ 255
        myPen = CreatePen(PS_SOLID, 5, RGB(rand() % 256, rand() % 256, rand() % 256));
        ...
        break;
    case WM_COMMAND:        // 메뉴, 버튼 입력 시 전달되는 메시지
        {
